...
class _RecipeUploadPageState extends State<RecipeUploadPage> {
  ...
  Future<void> _pickExcelFile() async {
    ...
    if (result != null) {
      ...
      List<Map<String, dynamic>> jsonArray = _convertExcelToJson(
          fileBytes); // Change this to List<Map<String, dynamic>>
      setState(() {
        _jsonArray =
            jsonEncode(jsonArray); // Encode the jsonArray to JSON string here
      });
    }
  }
